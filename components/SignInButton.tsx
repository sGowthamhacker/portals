...
const SignInButton: React.FC<SignInButtonProps> = ({ onClick }) => {
  return (
    <div className="signInButtonWrapper" onClick={onClick}>
      <style>{`
        .signInButtonWrapper {
        ...
        /* Dark mode adjustment if needed, though spec says black background */
        .dark .signInButton {
            border-color: white;
        }
      ...
      `}</style>
      <div tabIndex={0} className="signInButton rounded-sm">
