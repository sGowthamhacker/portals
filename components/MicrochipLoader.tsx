...
const MicrochipLoader: React.FC = () => (
    <svg className="microchip" viewBox="0 0 128 128" role="img" aria-label="A square pops in emitting waves and lines, and sparks run through the lines">
